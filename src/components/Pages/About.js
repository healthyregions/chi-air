    ...
    return (
       <AboutPage>
         ...
         <WhiteBackground $largeScreen={largeScreen}>
           ...
           <Grid container spacing={3} textAlign={'right'} marginTop={'2rem'}>
             <Grid size={12} style={{ fontFamily: 'Space Grotesk', fontSize: '18px', color: '##444444' }}>
              <b>Our Air</b>, a Chicago mapping Application, serves as a vital bridge between air quality data and community advocacy, making city-wide metrics legible for all. 
              ...
              <Grid size={12} style={{ fontFamily: 'Space Grotesk', fontSize: '18px', color: '##444444' }}>
               To achieve our goals, the design utilizes minimalism that balances technical density with cognitive ease. We chose a bright primary palette,
                ...
                By prioritizing clear visual hierarchy and 
                 transparent metadata, the dashboard reflects our mission of providing easy access to Chicago's air quality information.
             </Grid>
           </Grid>
         </WhiteBackground>
         ...
         <WhiteBackground $largeScreen={largeScreen}>
           ...
           <Grid container spacing={3} justifyContent={'right'} textAlign={'right'} marginTop={'2rem'}>
             <Grid size={12} style={{ fontFamily: 'Space Grotesk', fontSize: '18px', color: '##444444' }}>
              <NavLink to={'https://www.chicago.gov/city/en/depts/cdph/supp_info/Environment/open-air-chicago.html'} style={{ textDecoration: 'none', color: '#005899', fontWeight: 700 }}>Open Air Network</NavLink> 
             ...
             <Grid size={12} style={{ fontFamily: 'Space Grotesk', fontSize: '18px', color: '##444444' }}>
              The City of Chicago manages hourly and daily concentrations datasets published on its Data Portal as<NavLink to={'https://data.cityofchicago.org/Health-Human-Services/Open-Air-Chicago-Individual-Measurements/xfya-dxtq/about_data'} style={{ textDecoration: 'none', color: '#005899', fontWeight: 700 }}> Open Air Chicago Individual Measurements. </NavLink> 
             ...
             <Grid size={12} style={{ fontFamily: 'Space Grotesk', fontSize: '18px', color: '##444444' }}>
            <NavLink to={'https://publichealth.uic.edu/profiles/serap-erdal/'} style={{ textDecoration: 'none', color: '#005899', fontWeight: 700 }}>Dr. Serap Erdal </NavLink> 
             from UIC SPH led the scientific process of grid development, sensor placement, and quality assurance protocol development, with support from a Congressional Earmark Grant/National Institute of Standards and Technology (#60NANB23D206), and ComEd Hyperlocal Air Quality Assessment. RHP Risk Management/ComEd/Exelon, LLC from 2025 through 2026.       
              The sensor network has a five-year lifespan, with continuous monitoring, calibration, and refinement anticipated. </Grid>
              </Grid>
         </WhiteBackground>
